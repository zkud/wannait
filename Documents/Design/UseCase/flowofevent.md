...
2. Если данных недостаточно, выполняется альтернативный поток E1  
3. Приложение определяет оптимальные рекомендации, используя данные о пользователе и продуктах  
...
2. Приложение выполняет прецендент "[Просмотреть подробную информацию о своём продукте](#get_own_product_info)"
3. Вариант использования завершается  
...
**Основной поток.**
1. Приложение выводит список продуктов, принадлежащих владельцу, а в случае остутствия сообщение: "К сожалению, Вы пока что не добавили ни одного продукта"  
2. Вариант использования завершается  
...
**Основной поток.**
1. Пользователь нажал кнопку "delete" на [страницу с данными о его продукте](https://github.com/L1ttl3S1st3r/wannait/blob/master/Documents/images/mockups/Product%20info%20for%20owner%20%5BRead%20Mode%5D.png) 
2. Приложение отображает окно подтверждения действия  
3. Владелец нажимает "Ok" либо "Cancel"
...
3. Пользователь вводит данные о продукте    
