...
# Содержание 
1 [Войти в приложение](#sign_in_to_the_app)  
2 [Зарегистрироваться](#register)  
3 [Войти в свою учётную запись](#log_in_to_your_account)  
4 [Получить рекомендации](#login_without_registering)  
5 [Загрузить новости](#download_news)  
6 [Отфильтровать новости](#filter_the_news)  
7 [Просмотреть краткую информацию](#view_summary)  
8 [Просмотреть подробную информацию](#view_details)  
9 [Настроить профиль](#set_up_your_profile)  
10 [Добавить интернет-ресурс](#add_resource)  
11 [Удалить интернет-ресурс](#remove_resource)  
12 [Добавить ключевую фразу](#add_key)  
13 [Удалить ключевую фразу](#remove_key)  
14 [Выйти из учетной записи](#sign_out_of_your_account)  
...
## 7 Просмотреть краткую информацию
...
## 8 Просмотреть подробную информацию
