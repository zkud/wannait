...
**Постусловия.** В случае успешной регистрации выполняется варианты использования "[Получить персонализированные рекомендации](#get_personal_recommendations)" и "[Войти в учётную запись](#sign_in)".
