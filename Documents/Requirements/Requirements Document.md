...
Любой киноман или сериаломан проходит этап поиска нового продукта. Способы поиска могут быть разными, например, советы друзей или использование рекомендательных систем. Рекомендация является главной услугой, которую предоставляет приложение. Рекомендация, которая удовлетворяет запросам пользователя, будет иметь спрос. Рекомендации, имеющие спрос, возможно монетизировать.
![Граф поведения киномана или сериаломана](../images/behaviour.PNG)
