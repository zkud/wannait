...
* возможность рекомендации чего-то, отличающегося от продуктов, например, компьютерных игр, не предусмотрена. <br>
* Приложение не предоставляет функционал форума или блога. 
...
**Собственно требование.** Приложение должно предоставить правообладателю возможность добавлять новые продукты. <br>
...
**Собственно требование.** Приложение должно предоставить владельцу возможность просматривать принадлежащие ему продукты. <br>
...
**Собственно требование.** Приложение должно предоставить владельцу возможность редактировать информацию в принадлежащих ему продуктах. <br>
...
**Собственно требование.** Приложение должно предоставить владельцу возможность удалять продукты из приложения. <br>
...
**Собственно требование.** Приложение должно предоставить любому пользователю возможность просматривать информацию о продукте. <br>
...
**Собственно требование.** Приложение должно предоставить зарегистированному пользователю возможность комментировать продукты. <br>
...
Приложение должно стремиться к минимальному времени простоя.

<a name="scalability"/>

#### 3.2.1.2 Требования к масшатабируемости
Приложение может горизонтально масштабироваться.

<a name="ease_of_use"/>

#### 3.2.1.3 Требования к удобству использования
1 Количество элементов графического интерфейса должно стремиться к минимуму <br>
2 Количество действий для выполнения функции должно стремиться к минимуму <br>

<a name="extensibility"/>

#### 3.2.1.4 Требования к расширяемости
Спектр продуктов, предлагаемых приложением, можно расширить. Например, добавить рекомендацию книг, манги, аниме, игр. 

<a name="security_requirements"/>

#### 3.2.1.5 Требования к безопасности
1. Только владелец или администратор может изменять данные, связанные с продуктами владельца.
2. Только владелец учётной записи может ей пользоваться.

<a name="laws"/>

### 3.2.3 Юридические требования
Приложение должно предоставлять контактные данные владельцев приложения для решения вопросов с правообладателями.

<a name="restrictions"/>

### 3.2.4 Ограничения
1. Приложение реализовано на Python 3.
2. Приложение использует популярный web framework для Python 3, например Django.
