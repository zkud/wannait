...
3.2.1.6 [Требования к надежности](#reliability)
...
**Возможный способ измерения** Подсчёт количества пользователей с определённой переодичностью <br> 
